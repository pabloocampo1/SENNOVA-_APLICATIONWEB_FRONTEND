        ...
        <Box component={"section"} sx={{
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <CustomerInfoQuote handleOpenModalToSelectAnalisys={() => handleOpenModalToSelectAnalisys()  }/>
                </Box>
                ...
                <Box sx={{
                    ...
                    <QuotesSummaryProducts handleOpenModalToSelectAnalisys={() => handleOpenModalToSelectAnalisys()} />
                </Box>
            </Box>
